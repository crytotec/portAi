  ...
  return (
    <div className="w-full mt-20">
      <div className="relative flex flex-col md:flex-row p-5 justify-between items-center mx-auto gap-10 w-full md:w-[80%] h-auto">
        <div className='absolute  z-10 bg-gradient-to-t  bottom-0 from-blue-800 to-transparent w-full h-[200px]' />
        <div className='flex flex-col gap-10'>
          ...
          <a href='#projects' className="px-6 py-3 bg-blue-600 text-white rounded-xl shadow-md hover:bg-blue-300 duration-300 transition text-center">
            View My Work
          </a>
...
<div className='relative inline-block'>
  ...
  {chatOpen && (
    <div className="mt-4 w-full md:w-[400px] bg-white rounded-xl shadow-lg flex flex-col z-50 relative">
      ...
      <div className="relative flex  flex-col md:flex-row justify-between items-center mx-auto gap-10 p-5 w-full md:w-[80%]  h-auto">
        ...
        <div className='w-full h-auto bg-gradient-to-l pb-4 from-blue-700 to-blue-300'>
          <div className='flex flex-col justify-between items-center mx-auto gap-10 items-center p-10'>
            <h1>About Me</h1>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 place-items-center mx-auto p-2 gap-4 '>
            <div className='mx-10 w-full p-4 h-[150px] bg-gradient-to-l  from-blue-800 to-blue-400'>
              <div className='flex flex-col  p-4 gap-4'>
                <h3>💻 Frontend Development</h3>
                <p>Creating responsive, interactive user interfaces with React and Tailwind CSS.</p>
              </div>
            </div>
            <div className='mx-10 w-full h-[150px] bg-gradient-to-l p-4 from-blue-800 to-blue-400'>
              <div className='flex flex-col p-4 gap-4'>
  ...
  {/* Gradient Background */}
  <div className="absolute inset-0 -z-10 bg-gradient-to-r from-blue-900 via-blue-700 to-red-600 opacity-90 rounded-3xl shadow-2xl"></div>
  ...
  <div className="flex flex-row md:flex-wrap overflow-x-auto md:overflow-visible scrollbar-hide justify-start md:justify-center gap-8 w-full">
    {port.map((item, index) => (
      <div
        key={index}
        className="group flex-shrink-0 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 w-[270px] sm:w-[300px] md:w-[330px] overflow-hidden"
      >
        {/* Image */}
...
<div className=" w-full md:w-[80%] py-16  bg-gradient-to-r from-red-900 via-blue-700 to-blue-800 text-white flex flex-col mx-auto mt-5 items-center">
 ...
 <div className="w-full md:w-[80%] mx-auto mt-5  py-16 bg-gradient-to-l  from-gray-700 via-red-800 to-blue-600 text-white flex flex-col items-center">
...
<div className="relative flex flex-col items-center justify-center w-full md:w-[80%] items-center mx-auto py-20 px-6 md:px-10 bg-gradient-to-r from-red-600 via-blue-700 to-blue-900 text-white rounded-t-3xl mt-16">
